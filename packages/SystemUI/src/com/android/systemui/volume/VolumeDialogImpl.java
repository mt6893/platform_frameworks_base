...
public class VolumeDialogImpl implements VolumeDialog,
    ...
    private void initDialog() {
        ...
        mDialog.setOnShowListener(dialog -> {
            ...
            if (!shouldSlideInVolumeTray() && !isLandscape() || !mShowActiveStreamOnly) {
    ...
    protected void dismissH(int reason) {
        ...
        if (!shouldSlideInVolumeTray() && !isLandscape() || !mShowActiveStreamOnly) animator.translationX(getAnimatorX());
        animator.start();
